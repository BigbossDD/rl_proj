...
'''
this is the training script of DQN , it act like a connection hub between all 
elements of DQN , the agent the helper functions , and the enviroment , it recives parameters from 
main , and it return stats that will be used in ploting 
also here is where the weights and reward is saved 
'''
